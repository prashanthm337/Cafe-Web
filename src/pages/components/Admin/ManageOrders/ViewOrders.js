...
const ViewOrder = () => {    
    ...
    const columns = [
        ...
        { field: "barcode_number", headerName: "Token Number", width: 200 },
        { field: "serving_time", headerName: "Serving Time", width: 200 },
        { field: "student_id", headerName: "Student Reg No", width: 200 },
