    ...
    <Container>
      <Wrapper>
        ...
        <Right>
          ...
          <MenuItem onClick={() => navigate('/ProductList')}>Items</MenuItem>
          <MenuItem onClick={() => navigate('/Cart')}>Checkout</MenuItem>
          <MenuItem onClick={() => navigate('/Change')}>Setting</MenuItem>
          {/* <MenuItem onClick={() => navigate('/Product')}>Cart</MenuItem> */}
