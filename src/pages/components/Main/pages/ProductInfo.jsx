...
const cartData = () => {
      ...
      try {        
        ...
        //   const data = {student_id:id,cartList:productData};
        //   console.log(data);
      ...
      <Wrapper>
        ...
        <InfoContainer>
          ...
          <AddContainer>
            ...
            <Button onClick={cartData} style={{backgroundColor:"grey"}}>ADD_TO_CART</Button>
            {/* <Button onClick={getCart}>Get Cart</Button> */}
            {/* <Button onClick={removeData} style={{backgroundColor:"grey"}}>REMOVE</Button> */}
          </AddContainer>
        </InfoContainer>
      </Wrapper>
