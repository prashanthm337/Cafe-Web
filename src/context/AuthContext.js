...
export const AuthContextProvider = ({children}) => {
    ...
    const Login = userData => { 
        ...
        ApplicationStore().setStorage('id2',userData.id2);     
    ...
    const Logout = async() => {
        ...
        ApplicationStore().removeStorage('id2');
    ...
    return  (
        <AuthContext.Provider value={{ user, Login, user_type, loggedIn, Logout,user_email,AddToCart,getCart,removeToCart,url,trackId ,id,id2}}>
            {children}
...
export function useAuthContext(){
    const {user, Login, user_type, loggedIn, Logout,user_email,cart,AddToCart,getCart,removeToCart,url,trackId,id,id2} =  useContext(AuthContext);
    return {user, Login, user_type, loggedIn, Logout,user_email,cart,AddToCart,getCart,removeToCart,url,trackId,id,id2};
}
